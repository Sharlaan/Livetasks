export const tasks = {
  ...
  TASK_CREATE_INVALID_PARAM: 'Task creation requires a valid string for content parameter',
  ...
  TASK_REMOVE_INVALID_PARAM: 'Task deletion requires a valid number for id parameter',
